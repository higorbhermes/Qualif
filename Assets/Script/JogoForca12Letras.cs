...
public class JogoForca12Letras : MonoBehaviour {
...
public string url_completa, url_completa1, url_completa2, url_completa3, url_completa4, url_completa5, url_completa6, url_completa7, url_completa8, url_completa9, url_completa10, url_completa11, url_completa12;
public string letra, letra_digitada;
public int cont, opcao, acertos = 0, erros = 0;
public Text letra_um, letra_dois, letra_tres, letra_quatro, letra_cinco, letra_seis, letra_sete, letra_oito, letra_nove, letra_dez, letra_onze, letra_doze, letras_digitadas, dica;
public Text pontuacao, proximo_desafio;
public string letra_1 = "", letra_2 = "", letra_3 = "", letra_4 = "", letra_5 = "", letra_6 = "", letra_7 = "", letra_8 = "", letra_9 = "", letra_10 = "", letra_11 = "", letra_12 = "";
...
public bool ok_12 = false;
public bool liberar_fase = false;
public bool bloquear_jogo = false;
public bool limpar_mensagem = true;
public GameObject linha1, linha2,  linha3, linha4, linha5, linha6, linha7, linha9, linha8, linha10, linha11, linha12;
...
public bool letra1_revelada = false, letra2_revelada = false, letra3_revelada = false, letra4_revelada = false, letra5_revelada = false, letra6_revelada = false, letra7_revelada = false, letra8_revelada = false, letra9_revelada = false, letra10_revelada = false, letra11_revelada = false, letra12_revelada = false;
...
void Start(){
      ...
      url_completa12 = url_selectJogoForca+"?id="+UserData.id_jogo_forca_atual+"&opcao=14";
      WWW www12 = new WWW (url_completa12);
      Debug.Log(""+url_completa12); 
      StartCoroutine(Verificar_Letra12(www12));
...
void LetraA(){
    if (acertos<12 && erros<3 && a == false && liberado == true){
        letra_digitada = "A";
        a = true;
...
void LetraB(){
    if (acertos<12 && erros<3 && b == false && liberado == true){
        letra_digitada = "B";
        b = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraC(){
    if (acertos<12 && erros<3 && c == false && liberado == true){
        letra_digitada = "C";
        c = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraD(){
    if (acertos<12 && erros<3 && d == false && liberado == true){
        letra_digitada = "D";
        d = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraE(){
    if (acertos<12 && erros<3 && e == false && liberado == true){
        letra_digitada = "E";
        e = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraF(){
    if (acertos<12 && erros<3 && f == false && liberado == true){
        letra_digitada = "F";
        f = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraG(){
    if (acertos<12 && erros<3 && g == false && liberado == true){
        letra_digitada = "G";
        g = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraH(){
    if (acertos<12 && erros<3 && h == false && liberado == true){
        letra_digitada = "H";
        h = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraI(){
    if (acertos<12 && erros<3 && letra_i == false && liberado == true){
        letra_digitada = "I";
        letra_i = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraJ(){
    if (acertos<12 && erros<3 && j == false && liberado == true){
        letra_digitada = "J";
        j = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraK(){
    if (acertos<12 && erros<3 && k == false && liberado == true){
        letra_digitada = "K";
        k = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraL(){
    if (acertos<12 && erros<3 && l == false && liberado == true){
        letra_digitada = "L";
        l = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraM(){
    if (acertos<12 && erros<3 && m == false && liberado == true){
        letra_digitada = "M";
        m = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraN(){
    if (acertos<12 && erros<3 && n == false && liberado == true){
        letra_digitada = "N";
        n = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraO(){
    if (acertos<12 && erros<3 && o == false && liberado == true){
        letra_digitada = "O";
        o = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraP(){
    if (acertos<12 && erros<3 && p == false && liberado == true){
        letra_digitada = "P";
        p = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraQ(){
    if (acertos<12 && erros<3 && q == false && liberado == true){
        letra_digitada = "Q";
        q = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraR(){
    if (acertos<12 && erros<3 && r == false && liberado == true){
        letra_digitada = "R";
        r = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraS(){
    if (acertos<12 && erros<3 && s == false && liberado == true){
        letra_digitada = "S";
        s = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraT(){
    if (acertos<12 && erros<3 && t == false && liberado == true){
        letra_digitada = "T";
        t = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraU(){
    if (acertos<12 && erros<3 && u == false && liberado == true){
        letra_digitada = "U";
        u = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraV(){
    if (acertos<12 && erros<3 && v == false && liberado == true){
        letra_digitada = "V";
        v = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraX(){
    if (acertos<12 && erros<3 && letra_x == false && liberado == true){
        letra_digitada = "X";
        letra_x = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraW(){
    if (acertos<12 && erros<3 && w == false && liberado == true){
        letra_digitada = "W";
        w = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraY(){
    if (acertos<12 && erros<3 && y == false && liberado == true){
        letra_digitada = "Y";
        y = true;
        ConferirLetra(letra_digitada);
    }
...
void LetraZ(){
    if (acertos<12 && erros<3 && z == false && liberado == true){
        letra_digitada = "Z";
        z = true;
        ConferirLetra(letra_digitada);
    }
...
void FixedUpdate(){
 ...
 url_completa9 = url_selectJogoForca+"?id="+UserData.id_jogo_forca_atual+"&opcao=11";
    ...
    if (letra_1 =="" || letra_2  =="" || letra_3  =="" || letra_4 =="" || letra_5 =="" || letra_6 =="" || letra_7 =="" || letra_8 =="" || letra_9 =="" || letra_10 =="" || letra_11 =="" || letra_12 ==""){
       proximo_desafio.text = "Conectando ao Servidor...Aguarde um momento!";
       liberado = false;
    }
    else{
        liberado = true;
        if (acertos<12 || erros <3){  
            if (limpar_mensagem == true){
                    proximo_desafio.text = "";
            }
        }
    }
    if (Input.GetKeyDown(KeyCode.A) && acertos<12 && erros<3 && a == false && liberado == true){
        letra_digitada = "A";
        a = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.B) && acertos<12 && erros<3 && b == false && liberado == true){
        letra_digitada = "B";
        b = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.C) && acertos<12 && erros<3 && c == false && liberado == true){
        letra_digitada = "C";
        c = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.D) && acertos<12 && erros<3 && d == false && liberado == true){
        letra_digitada = "D";
        d = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.E) && acertos<12 && erros<3 && e == false && liberado == true){
        letra_digitada = "E";
        e = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.F) && acertos<12 && erros<3 && f == false && liberado == true){
        letra_digitada = "F";
        f = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.G) && acertos<12 && erros<3 && g == false && liberado == true){
        letra_digitada = "G";
        g = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.H) && acertos<12 && erros<3 && h == false && liberado == true){
        letra_digitada = "H";
        h = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.I) && acertos<12 && erros<3 && letra_i == false && liberado == true){
        letra_digitada = "I";
        letra_i = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.J) && acertos<12 && erros<3 && j == false && liberado == true){
        letra_digitada = "J";
        j = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.K) && acertos<12 && erros<3 && k == false && liberado == true){
        letra_digitada = "K";
        k = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.L) && acertos<12 && erros<3 && l == false && liberado == true){
        letra_digitada = "L";
        l = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.M) && acertos<12 && erros<3 && m == false && liberado == true){
        letra_digitada = "M";
        m = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.N) && acertos<12 && erros<3 && n == false && liberado == true){
        letra_digitada = "N";
        n = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.O) && acertos<12 && erros<3 && o == false && liberado == true){
        letra_digitada = "O";
        o = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.P) && acertos<12 && erros<3 && p == false && liberado == true){
        letra_digitada = "P";
        p = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.Q) && acertos<12 && erros<3 && q == false && liberado == true){
        letra_digitada = "Q";
        q = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.R) && acertos<12 && erros<3 && r == false && liberado == true){
        letra_digitada = "R";
        r = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.S) && acertos<12 && erros<3 && s == false && liberado == true){
        letra_digitada = "S";
        s = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.T) && acertos<12 && erros<3 && t == false && liberado == true){
        letra_digitada = "T";
        t = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.U) && acertos<12 && erros<3 && u == false && liberado == true){
        letra_digitada = "U";
        u = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.V) && acertos<12 && erros<3 && v == false && liberado == true){
        letra_digitada = "V";
        v = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.X) && acertos<12 && erros<3 && letra_x == false && liberado == true){
        letra_digitada = "X";
        letra_x = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.W) && acertos<12 && erros<3 && w == false && liberado == true){
        letra_digitada = "W";
        w = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.Y) && acertos<12 && erros<3 && y == false && liberado == true){
        letra_digitada = "Y";
        y = true;
        ConferirLetra(letra_digitada);
    }
    if (Input.GetKeyDown(KeyCode.Z) && acertos<12 && erros<3 && z == false && liberado == true){
        letra_digitada = "Z";
        z = true;
        ConferirLetra(letra_digitada);
    }
    ...
    if (acertos>=12){
        proximo_desafio.text = "Parabéns, você acertou!";
        timer -= Time.deltaTime;
    }
    if (erros>=3){
        timer -= Time.deltaTime;
    }
    if (acertos>=12 && liberar_fase == false){
    ...
    if (erros>=3 && bloquear_jogo == false){
        ...
        proximo_desafio.text = "Você Errou! A resposta correta era: "+letra_1+letra_2+letra_3+letra_4+letra_5+letra_6+letra_7+letra_8+letra_9+letra_10+letra_11+letra_12;
        bloquear_jogo = true;
    }
...
IEnumerator Verificar_Letra12(WWW www12){
        yield return www12;
        letra_12 = www12.text.ToString();
        letra_12 = letra_12.TrimEnd();
        ok_12 = true;
}
...
void ConferirLetra(string letra_digitada){
    ...
    if (letra_digitada == letra_11 && letra11_revelada == false){
        letra_onze.text = letra_digitada;
        acertos++;
        acertou = true;
        pontos = pontos + 20;
        letra11_revelada = true;
        Destroy(linha11);
    }
    if (letra_digitada == letra_12 && letra12_revelada == false){
        letra_doze.text = letra_digitada;
        acertos++;
        acertou = true;
        pontos = pontos + 20;
        letra12_revelada = true;
        Destroy(linha12);
    }
    Controle();
}
...
void Dica(){
    if (pontos>=40  && acertos<12 && erros<3){
        pontos = pontos - 40;
        Pontuacao();
...
void Revelar(){
    i = 1;
    if (acertos<=12 && liberado == true && pontos>=80 && acertos<12 && erros<3){
      pontos = pontos-80;
        while (i<12){
            Pontuacao();
            if (i == 1){
            ...
            if (i == 12){
                if(letra_doze.text == ""){
                    letra_doze.text = letra_12;
                    letra_revelada = letra_12;
                    acertos++;
                    i = 100;
                    x = 12;
                    Destroy(linha12);
        ...
        if (letra_revelada == letra_12 && x != 12){
            letra_doze.text = letra_revelada;
            acertos++;
            Destroy(linha12);
        }
        letra_revelada = "";
