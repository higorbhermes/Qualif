...
void FixedUpdate(){
 ...
 url_completa9 = url_selectJogoForca+"?id="+UserData.id_jogo_forca_atual+"&opcao=11";
    ...
    if (erros>=3 && bloquear_jogo == false){
        ...
        proximo_desafio.text = "Você Errou! A resposta correta era: "+letra_1+letra_2+letra_3+letra_4+letra_5+letra_6+letra_7+letra_8+letra_9+letra_10+letra_11+letra_12+". Aperte ESPAÇO ou clique em SAIR para encerrar a partida";
        bloquear_jogo = true;
    }
