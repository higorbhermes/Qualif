...
void FixedUpdate(){
 ...
 url_completa9 = url_selectJogoForca+"?id="+UserData.id_jogo_forca_atual+"&opcao=11";
    ...
    if (letra_1 =="" || letra_2  =="" || letra_3  =="" || letra_4 =="" || letra_5 =="" || letra_6 =="" || letra_7 =="" || letra_8 =="" || letra_9 =="" || letra_10 =="" || letra_11 ==""){
       proximo_desafio.text = "Conectando ao Servidor...Aguarde um momento!";
       liberado = false;
    }
    else{
        liberado = true;
        if (acertos<11 || erros <3){  
...
void Revelar(){
    i = 1;
    if (acertos<=11 && liberado == true && pontos>=80 && acertos<11 && erros<3){
      pontos = pontos-80;
        while (i<11){
            Pontuacao();
            if (i == 1){
